...
assets/           ไฟล์ LaTeX จริง (preamble + macro + ตัวอย่างเฉลยสองพาร์ท) ก๊อปไปใช้ได้เลย
...
| `preflight.py` | รวมทุกการตรวจไว้ในคำสั่งเดียว (รวมถึงเฉลยครบ 6 ส่วน) + ชี้หน้าที่ต้องดูด้วยตา |
