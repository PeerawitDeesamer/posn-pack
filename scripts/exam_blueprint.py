...
MATH_TOPICS = {
    ...
    'numtheory':  ('การหารลงตัว เศษเหลือ จำนวนเฉพาะ มอดุลาร์ (บวก ลบ คูณ)', 12, (2, 5)),
    'polynomial': ('พหุนาม แยกตัวประกอบ สมการ/อสมการดีกรีไม่เกิน 4', 8, (2, 4)),
    'func':       ('ความสัมพันธ์ ฟังก์ชัน กราฟกำลังสอง ฟังก์ชันประกอบ/ผกผัน', 8, (2, 5)),
    'relprop':    ('คุณสมบัติของความสัมพันธ์ สะท้อน สมมาตร ถ่ายทอด สมมูล', 4, (2, 4)),
    'explog':     ('ฟังก์ชันเอกซ์โพเนนเชียล ลอการิทึม และกราฟ', 5, (2, 4)),
    'equation':   ('อสมการเชิงเส้น สมการกำลังสอง ระบบสมการเชิงเส้นสองตัวแปร', 6, (1, 4)),
    'set':        ('เซต เพาเวอร์เซต ผลคูณคาร์ทีเซียน เพิ่มเข้า-ตัดออก', 6, (2, 4)),
    'logic':      ('ประพจน์ ตัวเชื่อม ตัวบ่งปริมาณ การอ้างเหตุผล จับโกหก', 7, (2, 5)),
    'geometry':   ('เรขาคณิตวิเคราะห์ พีทาโกรัส ความคล้าย วงกลม คอร์ด เส้นสัมผัส', 10, (2, 5)),
    'coordgeo':   ('เวกเตอร์ พิกัดบนระนาบ ระยะยุคลีเดียน รูปหลายเหลี่ยม นูน/เว้า พื้นที่', 7, (2, 5)),
    'counting':   ('หลักการบวก-คูณ เรียงสับเปลี่ยน/จัดหมู่ (ของต่างกันหมด) รังนกพิราบ', 10, (2, 5)),
    'sequence':   ('ลำดับเลขคณิต ลำดับเรขาคณิต ฟิโบนักชี (ไม่รวมอนุกรม)', 7, (2, 5)),
    'wordprob':   ('โจทย์การแก้ปัญหาเชิงคณิตศาสตร์ งาน อัตราเร็ว ผสมสาร', 6, (1, 4)),
}

COMP_TOPICS = {
    'pyexpr':    ('นิพจน์ไพธอน ลำดับดำเนินการ // % ** ชนิดข้อมูล', 9, (1, 3)),
    'pycond':    ('เงื่อนไข if ซ้อน and/or/not นิพจน์ตรรกะสมมูล', 9, (2, 4)),
    'pyloop':    ('วนซ้ำ while ไล่ค่าตัวแปร เงื่อนไขหยุด', 12, (2, 4)),
    'pynest':    ('ลูปซ้อนไม่เกิน 2 ชั้น นับรอบชั้นใน วิเคราะห์ตัวคูณ', 8, (3, 5)),
    'pyarray':   ('อาเรย์ 1 มิติ เข้าถึงด้วยดัชนี ไล่สมาชิกด้วย while', 10, (2, 4)),
    'pymix':     ('if+while ผสม ตัวไม่แปรผัน พิสูจน์ว่าหยุด/ไม่หยุด', 10, (3, 5)),
    'algotrace': ('ทำตามขั้นตอนวิธีที่โจทย์ให้ หาผลลัพธ์จากอินพุต', 13, (2, 4)),
    'algocount': ('นับจำนวนครั้งที่คำสั่ง/การเปรียบเทียบถูกทำงาน', 11, (3, 5)),
    'algomod':   ('เปลี่ยนขั้นตอนบางจุด แล้ววิเคราะห์ว่าผลลัพธ์เปลี่ยนอย่างไร', 9, (3, 5)),
    'simulate':  ('จำลองสถานการณ์ตามกฎที่ให้ (คิว ทรัพยากร เส้นทาง)', 9, (3, 5)),
    'greedy':    ('เลือกที่ดีที่สุดทีละขั้น ครอบคลุมช่วง จับคู่ ค่าสุดขีด', 7, (3, 5)),
}
